...
const FontShowcase = () => /* FontShowcase.tsx */
  ...
  return (
    <div className="p-8 my-4 bg-[#1e2022]">
      ...
      <section className="mb-8 ">
        ...
        <hr />
        <div className="font-inter-ui">
          <p className="font-inter-ui-normal">Inter UI Normal 400</p>
          <p className="font-inter-ui-bold">Inter UI Bold 800</p>
          <p className="font-inter-ui-italic">Inter UI Italic 400</p>
          <p className="font-inter-ui-italic-bold">Inter UI Italic Bold 800</p>
        </div>
      </section>
      <hr />1{" "}
      <section>
        ...
        <div className="font-inter-display">
          <p className="font-inter-display-semibold">Inter Display SemiBold 600</p>
        </div>
      </section>
    </div>
  );
